...
let forestBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "Forest Temple Boss Lock"});
let minesLock = new ConsumingObtainable("Lock", minesSK, {category: Categories.Locks, name: "Goron Mines Lock", consumesItem: true});
let minesBossLock = new ConsumingObtainable("Boss LockG", null, {category: Categories.Locks, name: "Goron Mines Boss Lock"});
...
let lakebedBossLock = new ConsumingObtainable("Boss LockL", null, {category: Categories.Locks, name: "Lakebed Temple Boss Lock"});
...
let arbitersBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "Arbiter's Grounds Boss Lock"});
...
let snowpeakBossLock = new ConsumingObtainable("Boss LockS", null, {category: Categories.Locks, name: "Snowpeak Ruins Boss Lock"});
...
let templeBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "Temple of Time Boss Lock"});
let cityLock = new ConsumingObtainable("Lock", citySK, {category: Categories.Locks, name: "City in the Sky Lock", consumesItem: true});
let cityBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "City in the Sky Boss Lock"});
...
let palaceBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "Palace of Twilight Boss Lock"});
let castleLock = new ConsumingObtainable("Lock", castleSK, {category: Categories.Locks, name: "Hyrule Castle Lock", consumesItem: true});
let castleBossLock = new ConsumingObtainable("Boss Lock", null, {category: Categories.Locks, name: "Hyrule Castle Boss Lock"});
